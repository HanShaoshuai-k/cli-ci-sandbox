	...
	tests := []struct {
	...
	}{
		{
			...
			wantHelp: []string{
				...
				"include Base automatic fields such as Created By and Modified Time",
			...
			wantTips: []string{
				...
				"lark-cli base +record-list --base-token <base_token> --table-id <table_id> --include-automatic-fields --limit 50",
